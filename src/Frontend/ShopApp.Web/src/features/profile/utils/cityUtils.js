/**
 * cityUtils.js — Türkiye il listesi ve yardımcı fonksiyonlar
 */
...
const cityMap = new Map(TURKEY_CITIES.map((c) => [c.code, c.name]));

export function getCityName(code) {
  return cityMap.get(Number(code)) ?? (code ? `Şehir #${code}` : 'Belirtilmemiş');
}
