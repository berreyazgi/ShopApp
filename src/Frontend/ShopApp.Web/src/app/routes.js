export const routes = [
  ...
  { path: '/admin/categories', title: 'Kategori Yönetimi', requiresAuth: true, roles: ['Admin'], page: () => import('../features/admin/pages/AdminCategoriesPage.js') },
  { path: '/admin/add-category', title: 'Yeni Kategori', requiresAuth: true, roles: ['Admin'], page: () => import('../features/admin/pages/AdminCategoriesPage.js') },
