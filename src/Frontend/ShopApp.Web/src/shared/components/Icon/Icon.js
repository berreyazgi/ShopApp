 ...
 *   const icon = createIcon('search', { size: 20, label: 'Ara' });
...
const icons = {
  ...
  cart: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><line x1="3" x2="21" y1="6" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>`,
  ...
  logo: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor"><rect width="32" height="32" rx="8"/><path d="M8 22V12a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v10" stroke="white" stroke-width="2" fill="none" stroke-linecap="round"/><circle cx="12" cy="22" r="2" fill="white"/><circle cx="20" cy="22" r="2" fill="white"/></svg>`,
  ...
  profile: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>`,
...
export function createIcon(name, options = {}) {
  ...
  wrapper.setAttribute('aria-hidden', label ? 'false' : 'true');
