...
## Corpus Check
- 57 files · ~9,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 261 nodes · 387 edges · 10 communities
...
8. `ShopApp.Infrastructure.Persistence` - 8 edges
9. `ShopApp.Application.Auth` - 7 edges
10. `src.Monolith.ShopApp.Domain.Common` - 7 edges
...
### Community 2 - "Siparis"
Cohesion: 0.09
Nodes (16): src.Monolith.ShopApp.Domain.Common, src.Monolith.ShopApp.Domain.Siparisler, DateTime, Guid, BaseEntity, Guid, ICollection, Siparis (+8 more)
...
Cohesion: 0.07
Nodes (28): ShopApp.Infrastructure.Persistence.Configurations.Identity, IdentityRoleClaim, IdentityUser, IdentityUserClaim, IdentityUserLogin, IdentityUserRole, IdentityUserToken, IEntityTypeConfiguration (+20 more)

### Community 6 - "Sepet"
Cohesion: 0.11
Nodes (15): src.Monolith.ShopApp.Domain.Sepet, ShopApp.Infrastructure.Persistence.Configurations, Guid, ICollection, Sepet, SepetDurum, SepetDurumLookup, Guid (+7 more)
...
### Community 8 - "Address"
Cohesion: 0.20
Nodes (8): src.Monolith.ShopApp.Domain.Kullanici, Guid, Address, Musteri, EntityTypeBuilder, AddressConfiguration, EntityTypeBuilder, MusteriConfiguration

### Community 9 - "IdentityRoleConfiguration"
Cohesion: 0.60
Nodes (4): EntityTypeBuilder, Guid, IdentityRole, IdentityRoleConfiguration

## Knowledge Gaps
- **32 isolated node(s):** `src.Monolith.ShopApp.Api.Controller`, `net10.0`, `Microsoft.AspNetCore.Authentication.JwtBearer (10.0.10)`, `Microsoft.EntityFrameworkCore.Design (10.0.10)`, `Microsoft.OpenApi (1.6.22)` (+27 more)
...
- **Why does `ShopAppDbContext` connect `ShopAppDbContext` to `Siparis`, `ShopApp.Application.Abstractions`, `IEntityTypeConfiguration`, `Sepet`, `Address`?**
  _High betweenness centrality (0.237) - this node is a cross-community bridge._
- **Why does `ShopApp.Infrastructure.Identity` connect `ShopApp.Application.Abstractions` to `IEntityTypeConfiguration`?**
