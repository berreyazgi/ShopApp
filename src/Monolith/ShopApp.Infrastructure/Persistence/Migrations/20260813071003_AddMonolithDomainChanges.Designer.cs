...
namespace ShopApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260813071003_AddMonolithDomainChanges")]
    partial class AddMonolithDomainChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopApp.Infrastructure.Identity.Models.KayitliKullanici", b =>
                {
                    ...
                    b.Property<string>("KullaniIsmi")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("Ad");

                    b.Property<string>("KullaniSoyismi")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("Soyad");
            ...
            modelBuilder.Entity("src.Monolith.ShopApp.Domain.Kullanici.Musteri", b =>
                {
                    b.HasOne("ShopApp.Infrastructure.Identity.Models.KayitliKullanici", null)
                        .WithOne()
                        .HasForeignKey("src.Monolith.ShopApp.Domain.Kullanici.Musteri", "IdentityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
