...
## Corpus Check
- 168 files · ~82,497 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 789 nodes · 1318 edges · 53 communities (50 shown, 3 thin omitted)
...
Cohesion: 0.06
Nodes (31): ShopApp.Infrastructure.Persistence.Configurations.Identity, IdentityRoleClaim, IdentityUserClaim, IdentityUserLogin, IdentityUserRole, IdentityUserToken, IEntityTypeConfiguration, DateTime (+23 more)
...
Cohesion: 0.06
Nodes (31): StokServis.Infrastructure.Persistence, StokServis.Migrations, StokServis.Domain.Entities, StokServis.Domain.Enums, StokServis.Domain.Common, DbContext, IDesignTimeDbContextFactory, DateTime (+23 more)

### Community 6 - "KargoGonderisi"
Cohesion: 0.09
Nodes (24): KargoServis.Infrastructure.Persistence, KargoServis.Domain.Common, KargoServis.Domain.Enums, KargoServis.Domain.Entities, DateOnly, DateTime, Guid, BaseEntity (+16 more)
...
Cohesion: 0.10
Nodes (11): KategoriServis.Migrations, ModelSnapshot, ModelBuilder, ShopAppDbContextModelSnapshot, ModelBuilder, KargoDbContextModelSnapshot, MigrationBuilder, ModelBuilder (+3 more)

### Community 10 - "IlkMigrasyon"
Cohesion: 0.28
Nodes (4): KargoServis.Migrations, MigrationBuilder, ModelBuilder, IlkMigrasyon

### Community 11 - "FeatureBenefits.js"
Cohesion: 0.28
Nodes (4): benefits, createFeatureBenefits(), createIcon(), icons

### Community 12 - "IdentityService"
Cohesion: 0.06
Nodes (40): ActionResult, Authorize, ControllerBase, HashSet, IActionResult, IdentityError, IdentityResult, Guid (+32 more)
...
### Community 21 - "Sepet"
Cohesion: 0.16
Nodes (11): src.Monolith.ShopApp.Domain.Sepet.Entities, ShopApp.Infrastructure.Persistence.Configurations, ICollection, Sepet, SepetDurumLookup, Guid, SepetUrunu, EntityTypeBuilder (+3 more)
...
Cohesion: 0.05
Nodes (31): ShopApp.Application.Auth, ShopApp.Infrastructure.Identity, ShopApp.Infrastructure.Authentication, ShopApp.Infrastructure.Persistence, ShopApp.Application.Services, ShopApp.Infrastructure, src.Monolith.ShopApp.Api.Controller, ShopApp.Application.Abstractions (+23 more)
...
### Community 40 - "Header.js"
Cohesion: 0.23
Nodes (10): subscribe(), navItems, getState(), initialState, notify(), resetStore(), setState(), state (+2 more)
...
- **Why does `ShopApp.Infrastructure.Persistence` connect `ShopApp.Application.Auth` to `MakeApplicationUserUpdatedAtRequired`, `InitialCreate`, `CreateMonolithTables`, `Migration`, `DatabaseChanges`, `AddMonolithDomainChanges`, `TurkcheIdentityVeMusteriGuncellemesi`, `ShopApp.Infrastructure.Persistence.Migrations`, `ShopAppDbContext`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `ShopAppDbContext` connect `ShopAppDbContext` to `IEntityTypeConfiguration`, `IdentityService`, `AdminProfile`, `BaseEntity`, `src.Monolith.ShopApp.Domain.Kullanici`, `src.Monolith.ShopApp.Domain.Common`, `Sepet`, `ShopApp.Application.Auth`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `IdentityService` connect `IdentityService` to `ShopAppDbContext`, `ShopApp.Application.Auth`?**
