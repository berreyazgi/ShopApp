...
## Corpus Check
- 161 files · ~91,263 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 833 nodes · 1321 edges · 70 communities (61 shown, 9 thin omitted)
...
7. `RegisterPage()` - 11 edges
8. `createFieldError()` - 11 edges
9. `Siparis` - 11 edges
10. `ShopApp.Infrastructure.Persistence.Migrations` - 11 edges
...
Cohesion: 0.21
Nodes (5): ShopApp.Application.Auth, ShopApp.Application.Abstractions, List, IShopAppDbContext, AuthRequest

### Community 1 - "router.js"
Cohesion: 0.06
Nodes (40): initApp(), bootstrap(), compileRoute(), guardedPath(), initRouter(), matchRoute(), navigate(), render() (+32 more)
...
Cohesion: 0.09
Nodes (33): appConfig, AUTH_STATUS, establishSession(), getCurrentUser(), login(), logout(), mapAuthResponse(), mapUser() (+25 more)

### Community 4 - "ShopApp.Infrastructure.Persistence.Migrations"
Cohesion: 0.24
Nodes (5): ShopApp.Infrastructure.Persistence.Migrations, ShopApp.Infrastructure.Persistence, ModelSnapshot, ModelBuilder, ShopAppDbContextModelSnapshot
...
### Community 7 - "SepetDurumLookup"
Cohesion: 0.40
Nodes (3): SepetDurumLookup, EntityTypeBuilder, SepetDurumLookupConfiguration

### Community 8 - "Address"
Cohesion: 0.19
Nodes (8): ShopApp.Infrastructure.Persistence.Configurations, src.Monolith.ShopApp.Domain.Kullanici, Guid, Address, Guid, Musteri, EntityTypeBuilder, AddressConfiguration
...
### Community 11 - "IdentityService"
Cohesion: 0.13
Nodes (14): IdentityError, IdentityResult, IdentityUser, RoleManager, Guid, IReadOnlyCollection, Task, IdentityService (+6 more)

### Community 12 - "src.Monolith.ShopApp.Domain.Siparisler"
Cohesion: 0.25
Nodes (5): src.Monolith.ShopApp.Domain.Siparisler, SiparisDurum, SiparisDurumLookup, Guid, SiparisUrunleri
...
### Community 16 - "Sepet"
Cohesion: 0.16
Nodes (9): src.Monolith.ShopApp.Domain.Sepet, src.Monolith.ShopApp.Domain.Common, ICollection, Sepet, SepetDurum, Guid, SepetUrunleri, EntityTypeBuilder (+1 more)
...
### Community 30 - "IIdentityService"
Cohesion: 0.21
Nodes (10): Guid, IReadOnlyCollection, Task, IIdentityService, IdentityUserInfo, Guid, IReadOnlyCollection, string (+2 more)

### Community 31 - "AuthResponse"
Cohesion: 0.14
Nodes (14): ActionResult, Authorize, HttpPost, HttpGet, Task, AuthController, Guid, Task (+6 more)
...
Cohesion: 0.29
Nodes (5): ControllerBase, src.Monolith.ShopApp.Api.Controller, IActionResult, HttpGet, AdminController
...
### Community 43 - "ShopApp.Infrastructure.Identity"
Cohesion: 0.22
Nodes (6): ShopApp.Infrastructure.Identity, ShopApp.Application.Services, ShopApp.Infrastructure, IConfiguration, IServiceCollection, DependencyInjection
...
### Community 67 - "BaseEntity"
Cohesion: 0.50
Nodes (3): DateTime, Guid, BaseEntity

## Knowledge Gaps
- **201 isolated node(s):** `initialState`, `state`, `subscribers`, `RFC-5322`, `benefits` (+196 more)
...
- **Why does `ShopApp.Infrastructure.Identity` connect `ShopApp.Infrastructure.Identity` to `ShopApp.Application.Auth`, `Address`, `IdentityService`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `ShopApp.Infrastructure.Persistence` connect `ShopApp.Infrastructure.Persistence.Migrations` to `Address`, `ShopAppDbContext`, `ShopApp.Infrastructure.Identity`?**
